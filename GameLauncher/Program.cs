    ...
    internal static class Program
    {
        ...
        private static void Main2(Arguments args)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show(null, "An instance of Need for Speed: World is already running", "NFSTR.Com Başlatıcı", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                ...
                try
                {
                    if (mutex.WaitOne(0, false))
                    {
                        ...
                        if (missingfiles.Count != 0)
                        {
                            ...
                            MessageBox.Show(null, message, "NFSTR.Com Başlatıcı", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        }
                        else
                        {
                            DoRunChecks(args);
                    ...
                    {
                        MessageBox.Show(null, "An instance of Launcher is already running.", "NFSTR.Com Başlatıcı", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                } 
                finally
                {
